...
<head>
	...
	<!-- Additional styles -->
	<link rel="stylesheet" href="<?php echo $path_css; ?>styles/agenda.css?v=1">
	<link rel="stylesheet" href="<?php echo $path_css; ?>styles/dashboard.css?v=1">
	<link rel="stylesheet" href="<?php echo $path_css; ?>styles/form.css?v=1">
	<link rel="stylesheet" href="<?php echo $path_css; ?>styles/modal.css?v=1">
	<link rel="stylesheet" href="<?php echo $path_css; ?>styles/progress-slider.css?v=1">
...
<body class="clearfix with-menu with-shortcuts">
	...
	<section id="menu" role="complementary">
		...
		<div id="menu-content">
			...
			<div id="profile">
				<img src="<?php echo $path_images; ?>user.png" width="64" height="64" alt="User name" class="user-icon">
				Hello
	...
	<script src="<?php echo $path_js; ?>developr.modal.js"></script>
	<script src="<?php echo $path_js; ?>developr.navigable.js"></script>
	<script src="<?php echo $path_js; ?>developr.notify.js"></script>
	<script src="<?php echo $path_js; ?>developr.scroll.js"></script>
	<script src="<?php echo $path_js; ?>developr.progress-slider.js"></script>
	<script src="<?php echo $path_js; ?>developr.tooltip.js"></script>
	<script src="<?php echo $path_js; ?>developr.confirm.js"></script>
	<script src="<?php echo $path_js; ?>developr.agenda.js"></script>
	<script src="<?php echo $path_js; ?>developr.tabs.js"></script>		<!-- Must be loaded last -->

	<!-- Tinycon -->
	<script src="<?php echo $path_js; ?>libs/tinycon.min.js"></script>
				...
				notify.showNotificationPermission('Your browser supports desktop notification, click here to enable them.', function()
				{
					...
					if (notify.hasNotificationPermission())
					{
						notify('Notifications API enabled!', 'You can now see notifications even when the application is in background', {
							icon: '<?php echo $path_images; ?>demo/icon.png',
							system: true
						});
					}
					else
